...
╔══════════════════════════════════════════════════════════════════════════════════╗
║                                                                                  ║
║     🤖 REFi BOT - COMPLETE FINAL VERSION v20.0                                   ║
...
def handle_verify(callback, uid, chat_id, msg_id):
    ...
    edit_message(chat_id, msg_id, f"✅ *Verified!*\n✨ +{format_refi(WELCOME_BONUS)}\n💰 {format_refi(new_balance)}", main_keyboard(u))
